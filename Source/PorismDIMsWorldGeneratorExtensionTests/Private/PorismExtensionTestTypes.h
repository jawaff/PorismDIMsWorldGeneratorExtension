...
USTRUCT()
struct FPorismExtensionDerivedHealthCustomData : public FBlockHealthCustomData
{
	GENERATED_BODY()
...
USTRUCT()
struct FPorismExtensionDerivedHealthDefinition : public FBlockHealthDefinition
{
	GENERATED_BODY()
